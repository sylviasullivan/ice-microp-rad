...
stats1_fixed = syn_traj_stats_fixed( alt_ICON1, temp_ICON1, press_ICON1, qv_ICON1, idx[0], bins_sims )
np.save('../../output/ICON_syntrajs_0V1M0A0R_stats_fixed.npy', stats1_fixed)
stats2_fixed = syn_traj_stats_fixed( alt_ICON2, temp_ICON2, press_ICON2, qv_ICON2, idx[1], bins_sims )
np.save('../../output/ICON_syntrajs_0V2M0A0R_stats_fixed.npy', stats2_fixed)
stats3_fixed = syn_traj_stats_fixed( alt_ICON3, temp_ICON3, press_ICON3, qv_ICON3, idx[2], bins_sims )
