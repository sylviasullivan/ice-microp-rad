...
stats1 = syn_traj_stats( alt_ICON1, temp_ICON1, press_ICON1, qv_ICON1, idx[0] )
np.save('../../output/ICON_syntrajs_0V1M0A0R_stats.npy', stats1)
stats2 = syn_traj_stats( alt_ICON2, temp_ICON2, press_ICON2, qv_ICON2, idx[1] )
np.save('../../output/ICON_syntrajs_0V2M0A0R_stats.npy', stats2)
stats3 = syn_traj_stats( alt_ICON3, temp_ICON3, press_ICON3, qv_ICON3, idx[2] )
