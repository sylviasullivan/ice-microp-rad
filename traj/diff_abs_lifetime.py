...
clams_fi = xr.open_dataset( basedir + 'CLAMS-Tf_0V1M0A0R_tst00001350_trim_extract_dt_iwc_filter.nc' )
icon_fi = xr.open_dataset( basedir + 'ICON_0V1M0A0R_tst00001350_trim_extract_dt_filter.nc' )
...
for j in np.arange(n):
    if (j%100 == 0) & (j != 0):
       print( j )
       np.save( '/xdisk/sylvia/scratch/qi_ppmv_abs_diff_vals' + str(c) + '_1M.npy', diff_vals )
       np.save( '/xdisk/sylvia/scratch/qi_ppmv_abs_icon_vals' + str(c) + '_1M.npy', val1_list )
       np.save( '/xdisk/sylvia/scratch/qi_ppmv_abs_clams_vals' + str(c) + '_1M.npy', val2_list )
       c = c + 1
...
np.save( '/xdisk/sylvia/scratch/qi_ppmv_abs_diff_vals' + str(c) + '_1M.npy', diff_vals )
np.save( '/xdisk/sylvia/scratch/qi_ppmv_abs_icon_vals' + str(c) + '_1M.npy', vals1 )
np.save( '/xdisk/sylvia/scratch/qi_ppmv_abs_clams_vals' + str(c) + '_1M.npy', vals2 )
