...
def meanProfile(basedir,tag,f,startindx,endindx):
    ...
    np.save('../output/QI_' + tag + '_' + suffix2 + '.npy',QI)
    return QI

if arr[0] == True:
   QI_1mom = meanProfile('/scratch/b/b380873/tropic_run2/','1mom',0,1,24)
else:
   QI_1mom = np.load('../output/QI_1mom' + suffix2 + '.npy')


if arr[1] == True:
   QI_no2mom = meanProfile('/scratch/b/b380873/tropic_run5_no2mom/','no2mom',0,1,24)
else:
   QI_no2mom = np.load('../output/QI_no2mom' + suffix2 + '.npy')


if arr[2] == True:
   QI_novgrid = meanProfile('/scratch/b/b380873/tropic_run5_novgrid/','novgrid',0,1,24)
else:
   QI_novgrid = np.load('../output/QI_novgrid' + suffix2 + '.npy')


if arr[3] == True:
   QI_2mom = meanProfile('/scratch/b/b380873/tropic_run5/','2mom',0,49,70)
else:
   QI_2mom = np.load('../output/QI_2mom' + suffix2 + '.npy')

if arr[4] == True:
   QI_Atest = meanProfile('/scratch/b/b380873/tropic_run6/','Atest',0,1,23)
else:
...
fig.savefig('../output/qi-profiles.pdf')
plt.show()
